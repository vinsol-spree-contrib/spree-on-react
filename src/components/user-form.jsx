...
class userFormBlock extends Component {
  ...
  render() {
    return (
      <article className={ "global-modal user-from-modal " + (this.props.showModal ? 'show-modal' : '') }>
        ...
        <div className="center-block user-form-process">
          <div className="cmn-user-form">
            <div className="form-heading-title center-heading no-border big">Account</div>
            { this.props.children }
          </div>
        </div>
